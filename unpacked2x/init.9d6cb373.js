...
var devToolTheme = chrome && chrome.devtools && chrome.devtools.panels && chrome.devtools.panels['themeName'];
window.theme = devToolTheme && devToolTheme.toLowerCase().includes('dark') ? 'dark' : 'light';
var preload = document.getElementById('preload');
if (preload) preload.setAttribute("data-".concat(window.theme), "");
